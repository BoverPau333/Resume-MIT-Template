...
%----------HEADING----------
\begin{center}
    \textbf{\Huge Pau Bover Femenias} \\ \vspace{10pt}
    \small 
    \hspace{1pt}\faPhone* \texttt{+XX XXX XXX XXX} \hspace{1pt} $|$
    \hspace{1pt} \faEnvelope \hspace{2pt} \texttt{xxxxxxxxxxxx@gmail.com} \hspace{1pt} $|$ 
    \hspace{1pt} \faGithub \hspace{2pt} \texttt{BoverPau333} \hspace{1pt} $|$
    \hspace{1pt} \faMapMarker* \hspace{2pt}\texttt{Palma de Mallorca - Spain}
    \\ \vspace{-3pt}
\end{center}
...
\section{EXPERIENCE}
  \resumeSubHeadingListStart
    ...
    {CEO \& Lead Developer}{Palma, Spain / Barcelona, Spain}
            \resumeItemListStart
